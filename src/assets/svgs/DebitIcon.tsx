...
const DebitIcon = (props: SvgProps) => (
  <Svg width={35} height={35} viewBox="0 0 35 35" fill="none" {...props}>
    <Rect width={35} height={35} rx={17.5} fill="#FFA500" />
    <Path
    ...
    />
    <Path
      d="M20.4167 22.5H11.6667C11.2246 22.5 10.8007 22.3244 10.4882 22.0118C10.1756 21.6993 10 21.2754 10 20.8333V14.1667C10 13.7246 10.1756 13.3007 10.4882 12.9882C10.8007 12.6756 11.2246 12.5 11.6667 12.5H23.3333C23.7754 12.5 24.1993 12.6756 24.5118 12.9882C24.8244 13.3007 25 13.7246 25 14.1667V17.5M23 21H25H27"
      stroke="white"
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
